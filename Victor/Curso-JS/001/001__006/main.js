...
function agruparElementos(array) {
    ...
    return (arrayNumber.join() + ',' + arrayString).split();
}
...
function ponerBonitasLasLetras(array) {
    ...
    for (var i = 0; i < array.length; i++) {
        if (typeof (array[i]) == 'number') {
            ...
            if (re.test(array[i])) {
                arrayTemp.push(array[i].toUpperCase());
            } else {
                arrayTemp.push(array[i].toLowerCase());
            }
        }
    }
...
//console.log(vaciarPapelera(["a", 6, "B", "F", "*", 8, 78, "J"]));
//console.log(agruparElementos(["a", 6, "B", "F", "*", 8, 78, "J"]));
//console.log(ponerBonitasLasLetras(["a", 6, "B", "F", "*", 8, 78, "J"]));
console.log(ponerBonitosLosNumeros(["a", 6, "B", "F", "*", 8, 78, "J"]));