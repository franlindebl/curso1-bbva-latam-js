...
function ejecutarCiclo() {
    ...
    // Ejecutar un ciclo en todos los animales
    var listadoAnimales = zoo.getListadoAnimales();
...
/*
1) Añadir a animal 2 funciones:
    - modificarSalud() que recibirá el valor a sumar.
    - modificarHambre() que recibirá el valor a sumar a hambre.
2) Añador a animal dos funciones:
    - ejecutaCicloAnimal que se encargue de modificar la salud del propio animal
      de forma aleatoria en cada ciclo, y añadirle 10 de hambre.
*/