class Pokemon {
    ...
    _getRowForTable() {
        ...
        fila += '<td><button id="btVerDetalle_' + id[6] + '" class="buttonVer">Ver Detalle</button>';
...
*/
    ...
    pintarHeader() {
        let estructura = '';
        estructura += '<p><h1>La Pokedex Xanxa!</h1></p>';
        estructura += '<div class="divsHeader"><button id="btnAnterior" class="buttonVer">< Anterior</button></div>';
        estructura += '<div id="paginaActual" class="divsHeader">Página actual: '+ this._paginaActual +'</div>';
        estructura += '<div class="divsHeader"><button id="btnSiguiente" class="buttonVer">Siguiente ></button></div>';
    ...
    pintarPagina() {
        this._pokemonApi.getPokemonsAtPage(this._paginaActual).then(
            (data) => {
                ...
                paginaActual.innerHTML = "Página actual: "+ (this._paginaActual);
            }
        );
    }
