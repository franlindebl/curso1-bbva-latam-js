...
var zoo = {
	...
	encargado : {
		...
		revisarAnimales: function(){
			var listadoAnimales = zoo.getListadoAnimales(); //zoo.encarfado,revisarAnimales();
...
function animales(nombre, especie, salud, hambre, pais){
	return {
    	...
    	ejecutarCicloAnimal: function(){
            ...
            //this.modificarSaludAleatoria(this.nombre);
...
function ejecutarCiclo(){
	...
	//Ejecuta un ciclo en todos los animales
...
function crearPaciente(animal, recinto){
    ...
    console.log("Animal estas maldito. ¿Que animal eres?");
	animal.emitirSonido();
...
-modificarSalud() que recibira el valor a sumar a salud
-modificarHambre() que recibira el valor a sumar a hambre

2)Añadir a animal dos funciones:
-ejecutarCicloAnimal() que se encargue de modificar la salud 
del propio animal de forma aleatoria en cada ciclo y añadoirle 10 de hambre
