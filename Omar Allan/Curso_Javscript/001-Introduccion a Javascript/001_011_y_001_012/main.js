...
//     Estudiantes 3 pesos
//     Resto 5 pesos
/*2) Crea una función que se llame ejecutarCiclo() que simule el paso de 1 hora en el zoo, deberá:
- Añadir visitantes al parque y también los retire del parque
- Deberá quedar reflejado que ha pasado un ciclo en el importe de las personas (tendrán menos dinero) y en la caja del parque (habrá ganado dinero)
...
- Su salud se verá afectada disminuyendo o aumentando 10 (de forma
aleatoria).
- Si la salud del animal desciende por debajo de 50, este deberá ir a la
enfermería.
- También el animal tendrá más hambre cada hora que pase (+10) cuando
llegue a 100 deberá ser alimentado y pasará a tener hambre 0.
4) Asocia la funcionalidad anterior a la función de ejecutarCiclo() de manera que los animales vayan variando su salud y su hambre.
De vez en cuando algunos animales deberán ir a la enfermería (salud menor de 50) donde recuperarán 10 de salud hasta llegar a 100.
Al llegar a 100 deberán volver a su recinto.
*/
