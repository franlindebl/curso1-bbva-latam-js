...
var zoo = {
	...
	getRecintoDeEspecie: function(especie){
	    ...
	    while (!recinto && indiceArea<this.areas.length){
	        ...
	        var indiceRecinto = 0;
	        while (!recinto && indiceRecinto<area.recintos.length) {
	            var recintoAux = area.recintos[indiceRecinto];
...
zoo.encargado = {
		...
		devolerAnimalesRecuperados: function(animalesRecuperados) {
...
function recintoDetalles(nombre, animales, capacidad, detalle, especie){
	return {
		nombre: nombre,
		animales: animales,
		capacidad: capacidad,
...
var Animal = function(nombre, especie, salud, hambre, pais){
		...
		this.modificarSalud = function(incrementoSalud){
		...
		this.modificarHambre = function(incrementoHambre){
		...
		this.ejecutarCicloAnimal = function(){
			// Añadir 10 de hambre
		...
		this.estaEnfermo = function (){
		    return this.salud<50;
		};
		this.tieneHambre = function (){
...
var recinto1 = recintoDetalles("Jaula de tigres", tigres, 10, "Jaula super reforzada con titanium","tigre");
var recinto2 = recintoDetalles("Baños", [], 50, "Baños para hombres y mujeres, aptos para personas con discapacidad","humano");
var recinto3 = recintoDetalles("Jaula para aves", aves, 10, "Algunas aves que se pelean a seguido","ave");
